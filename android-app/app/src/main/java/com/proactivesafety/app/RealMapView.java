...
public class RealMapView extends WebView {
    ...
    private String html() {
        ...
        return "<!doctype html><html><head><meta name='viewport' content='width=device-width,initial-scale=1'>" +
                ...
                ".marker{position:absolute;z-index:3;transform:translate(-50%,-50%);pointer-events:none;transition:left .28s linear,top .28s linear,transform .18s linear}.arrow{width:0;height:0;border-left:14px solid transparent;border-right:14px solid transparent;border-bottom:42px solid #29c7a4;filter:drop-shadow(0 0 4px #07130f)}" +
                ".otherArrow{width:0;height:0;border-left:10px solid transparent;border-right:10px solid transparent;border-bottom:31px solid #8fb7aa;filter:drop-shadow(0 0 4px rgba(0,0,0,.9))}.otherDanger .otherArrow{border-bottom-color:#ff4d4d;filter:drop-shadow(0 0 6px #ff4d4d)}.otherLabel{position:absolute;left:50%;top:28px;transform:translateX(-50%);white-space:nowrap;color:white;background:rgba(0,0,0,.62);border-radius:8px;padding:2px 6px;font-size:10px;font-weight:700}.zone{width:170px;height:170px;border-radius:50%;border:2px solid #29c7a4;background:rgba(41,199,164,.16)}" +
